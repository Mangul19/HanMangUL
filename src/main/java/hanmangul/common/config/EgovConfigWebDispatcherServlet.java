...
import hanmangul.api.common.interceptor.ApiInterceptor;
import hanmangul.common.interceptor.AuthenticInterceptor;
 ...
 */
@Configuration
@ComponentScan(basePackages = "hanmangul", excludeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, value = Service.class), @ComponentScan.Filter(type = FilterType.ANNOTATION, value = Repository.class),
...
public class EgovConfigWebDispatcherServlet implements WebMvcConfigurer {
    ...
    // private final String[] CORS_ORIGIN_SERVER_URLS = {"http://127.0.0.1:3000",
    // "http://localhost:3000"};
    ...
    @Bean
    public ApiInterceptor apiLogInterceptor() {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        // .addPathPatterns("/api/**/*");"
        registry.addInterceptor(authenticInterceptor()).addPathPatterns("/**").excludePathPatterns("/login/**").excludePathPatterns("/api/**").excludePathPatterns("/css/**").excludePathPatterns("/cont/**").excludePathPatterns("/html/**").excludePathPatterns("/images/**")
