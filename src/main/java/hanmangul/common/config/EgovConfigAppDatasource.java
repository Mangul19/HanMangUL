...
public class EgovConfigAppDatasource {
    ...
    void init() {
        // Exception 처리 필요
        className = env.getProperty("Globals.postgres.DriverClassName");
        url = env.getProperty("Globals.postgres.Url");
        userName = env.getProperty("Globals.postgres.UserName");
        password = env.getProperty("Globals.postgres.Password");
    }
