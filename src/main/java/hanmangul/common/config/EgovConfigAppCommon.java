...
import hanmangul.common.config.etc.EgovComTraceHandler;
import hanmangul.common.config.etc.EgovMessageSource;
import hanmangul.common.config.etc.EgovMultipartResolver;
import hanmangul.common.config.etc.ImagePaginationRenderer;
 ...
 */
@Configuration
@ComponentScan(basePackages = "hanmangul", includeFilters = { @ComponentScan.Filter(type = FilterType.ANNOTATION, value = Service.class), @ComponentScan.Filter(type = FilterType.ANNOTATION, value = Repository.class) }, excludeFilters = {
...
public class EgovConfigAppCommon {
    ...
    public ReloadableResourceBundleMessageSource messageSource() {
        ...
        reloadableResourceBundleMessageSource.setBasenames("classpath:/egovframework/message/com/message-common", "classpath:/org/egovframe/rte/fdl/idgnr/messages/idgnr", "classpath:/org/egovframe/rte/fdl/property/messages/properties");
