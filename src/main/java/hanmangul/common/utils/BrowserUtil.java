...
public class BrowserUtil {
     ...
     * String testUserAgent[] = { // IE 7.0
     * "Mozilla/4.0 (compatible; MSIE 7.0; Windows NT 6.0)"
     * ,"Mozilla/4.0 (Mozilla/4.0; MSIE 7.0; Windows NT 5.1; FDM; SV1; .NET CLR 3.0.04506.30)"
     * // IE 8.0 ,"Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0)"
     * // IE 9.0 ,"Mozilla/5.0 (compatible; MSIE 9.0; Windows NT 6.1; Trident/5.0)"
     * // IE 10.0
     * ,"Mozilla/5.0 (compatible; MSIE 10.0; Windows NT 6.2; Trident/6.0)" // IE
     * 11.0 ,"Mozilla/5.0 (Windows NT 10.0; WOW64; Trident/7.0; rv:11.0) like Gecko"
     ...
     * 
     * HashMap<String,String> result = null; for (int i = 0; i <
     * testUserAgent.length; i++) { result = getBrowser(testUserAgent[i]);
     ...
     * //System.out.println("2. Browser Version convert: "+Float.parseFloat(result.
     * get(VERSIONKEY))); System.out.println(""); }
     * 
     * }
     */
