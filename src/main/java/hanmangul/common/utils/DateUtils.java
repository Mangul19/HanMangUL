...
public class DateUtils {
    ...
    /**
     * 년-월-일 을 입력받아 요일을 반환한다. dateString 의 형식은 yyyy-MM-dd / yyyy.MM.dd / yyyyMMdd /
     * yyyy/MM/dd 형식을 지원한다. default 로 TestStyle.FULL 스타일을 적용한다.(ex. 목요일) TextStyle 을
     * 변경하여 다양한 형태로 요일을 출력할 수 있다.(ex. TextStyle.SHORT -> 목)
     */
    ...
    /**
     * 오늘기준 특정 요일의 날짜 구하기 isNext 로 이전, 이후를 결정 오늘은 이전에 포함
     */
